        ...
        <div>
            {!orderId
                ? <div>
                    ...
                    <form style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }} onSubmit={finalizarCompra}>
                        ...
                        <div class="mb-3">
                            ...
                            <input className="form-control" type="number" placeholder='+54' name="phone" onChange={datosComprador} />
                        </div>
                        <div class="mb-3">
                        ...
                        {mensaje && <p style={{ color: 'red' }}> Rellenar Campos</p>}
                    </form>
                </div>
                :
                <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
                    ...
                    <button className="btn btn-success" onClick={() => navigate('/')}>Regresar</button>
                </div>}
        </div>
    )
}
